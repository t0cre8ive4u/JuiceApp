...
if (mysqli_connect_errno())
  ...
  $sql="INSERT INTO queue (Apple, Cranberry, Grape, Lemonade, Orange, Name)
VALUES
...
'".mysqli_real_escape_string ($con,$_POST["Lemonade"])."',
...
if (mysqli_connect_errno())
  ...
  if (!isset($_POST["programic"])) {
  $sql="INSERT INTO saved (Apple, Cranberry, Grape, Lemonade, Orange, Name)
VALUES
('".mysqli_real_escape_string ($con,$_POST["Apple"])."',
'".mysqli_real_escape_string ($con,$_POST["Cranberry"])."',
'".mysqli_real_escape_string ($con,$_POST["Grape"])."',
...
if (mysqli_connect_errno())
  ...
  if (!isset($_POST["programic"])) {
  $sql="INSERT INTO history (Apple, Cranberry, Grape, Lemonade, Orange, Name)
VALUES
('".mysqli_real_escape_string ($con,$_POST["Apple"])."',
'".mysqli_real_escape_string ($con,$_POST["Cranberry"])."',
'".mysqli_real_escape_string ($con,$_POST["Grape"])."',
